    ...
    const handleContactForm = (e) => {
        ...
        if (name && email && message) {
            if (isEmail(email)) {
                ...
                emailjs.sendForm('service_bmz6kns', 'template_irsfppu', e.target, 'IPYLmr56gm3jq8OZq')
                    .then(() => {
                        console.log('SUCCESS!');
                        setSuccess(true);
                        setErrMsg('');
    ...
    return (
        <div className='contacts' id='contacts' style={{ backgroundColor: theme.secondary }}>
            <div className='contacts--container'>
                <h1 style={{ color: theme.topic }}>Contact Me</h1>
                <div className='contacts-body'>
                    ...
                    <div className='contacts-details'>
                        ...
                        <div className='socialmedia-icons'>
                            ...
                            {socialsData.behance && (
                                <a href={socialsData.behance} target='_blank' rel='noreferrer' className={classes.socialIcon}>
